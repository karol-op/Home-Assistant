...
Home Assistant ([open source home automation platform focused on local control and privacy](https://www.home-assistant.io/)) - configuration and documentation for my Smart Home. I run my instance on Raspberry Pi 3B+, with external access possible by [nabucasa](https://www.nabucasa.com/) 5$/month subscription service (which btw I recommend if you don't have much time to play with DNS and stuff). If you want to do some integration or automation as I did, remember to not copy line to line, you have to understand the code to properly install it - if you have any problems, contact me, I will try to help you as best as I can.
